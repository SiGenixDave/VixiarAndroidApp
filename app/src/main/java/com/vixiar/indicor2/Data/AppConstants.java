...
public class AppConstants
{
    ...
    public static final int LOW_LEVEL_BASELINE_FOR_AMBIENT_LIGHT = 10000;
    public static final int SECONDS_BEFORE_T0_FOR_RESULTS_GRAPH = 20;
    public static final int LENGTH_OF_RESULTS_GRAPH = 50;
    public static final double STD_DEVS_ABOVE_MEAN_LIMIT_FOR_MOVEMENT_BASELINE = 3.5;
    public static final double STD_DEVS_ABOVE_MEAN_LIMIT_FOR_MOVEMENT_VALSALVA = 4.5;
    ...
    public static final int MAX_SLOPE_FOR_UNSTABLE_BASELINE_PCT = 40;
